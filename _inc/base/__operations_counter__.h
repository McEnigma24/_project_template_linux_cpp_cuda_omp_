...
namespace CORE
{
    ...
    public:
        ...
        Operation_Counter(const T& v) : value(v) { OP_C_SHOW_LOG_LINE(line("constructor")); }
        Operation_Counter(Operation_Counter&& v) : value(v.value) { OP_C_SHOW_LOG_LINE(line("move constructor")); }
        ...
        friend std::ostream& operator<<(std::ostream& stream, const Operation_Counter& obj)
        {
            // line("stream"));
            stream << obj.value;
            return stream;
